    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass("GameController"), _dec2 = property({
        ...
        displayImages() {
          ...
          var spriteFrame = this.listCardRes[this.randomValueCardL - 1];
        ...
        displayImagesCardR() {
          ...
          var spriteFrame = this.listCardRes[this.randomValueCardR - 1];
        ...
        drawRectanglel(Avatar) {
          var width = 220;
          var height = 100;
          var graphics = Avatar.addComponent(Graphics); // graphics.rect(-width / 2, -height / 2, width, height);
...
//# sourceMappingURL=383ea7ac0a9edfaf4008e17a9c4b1b03e97f569d.js.map